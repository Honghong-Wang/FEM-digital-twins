...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run the Level-4 representative T6/QP all-step FEM audit suite. "
            "Each case uses QP-thermo-hard HistoryGNO, monotonic training, cyclic testing, "
            "50 epochs, five seeds, and all-step residual/energy audit loss."
        )
    )
    ...
    for case in cases:
        ...
        stem = f"level4_t6_qp_allstep_representative_{case}"
